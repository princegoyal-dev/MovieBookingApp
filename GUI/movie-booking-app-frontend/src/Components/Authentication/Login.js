...
const Login = () => {
    ...
    const containerStyle = {
        ...
        height: '100vh',
        backgroundImage: "url('https://img.freepik.com/free-photo/videotape-with-3d-glasses-cinema-menu_23-2148133565.jpg?w=996&t=st=1687374016~exp=1687374616~hmac=1b4527361db7855b0832211ade1733898220955d3489e2876cbe8fa9a15cfeb1')",
    ...
    <input style={inputStyle} type="text" name="loginId" placeholder="Login ID" />
    ...
    <p style={footerStyle}>© 2023 Movie Booking App. All rights reserved.</p>
    </div>
    </>
);
};
